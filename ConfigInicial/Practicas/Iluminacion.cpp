...
int main()
{
    ...
    Model piso((char*)"Models/piso.obj");  // SEGUNDO MODELO AÑADIDO
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Draw the second model (piso) - MODIFICADO
        glm::mat4 model2(1);
        model2 = glm::translate(model2, glm::vec3(0.0f, -2.0f, 0.0f)); // Posicionado debajo del perro
        model2 = glm::scale(model2, glm::vec3(5.0f, 0.1f, 5.0f)); // Escala adecuada para piso
        glUniformMatrix4fv(glGetUniformLocation(lightingShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model2));
        piso.Draw(lightingShader);
        //Tercer modelo
        glm::mat4 model3(1);
        model3 = glm::translate(model3, glm::vec3(0.0f, 0.0f, 0.0f)); // Posicionado debajo del perro
        model3 = glm::scale(model3, glm::vec3(1.0f, 1.0f, 1.0f)); // Escala adecuada para piso
